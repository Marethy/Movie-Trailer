      ...
      <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
        <div>
          ...
          <p className="text-sm mt-12 text-gray-800">
            ...
            <Button type="link" onClick={() => navigate("/register")} className="text-blue-600 font-semibold hover:underline ml-1">
              Register here
            </Button>
          </p>
        </div>

        <div className="max-w-md md:ml-auto w-full bg-white p-8 rounded shadow-md">
          ...
          >
            ...
            <Form.Item>
              ...
              <a className="float-right text-blue-600 hover:text-blue-500 font-semibold" href="javascript:void(0);">
